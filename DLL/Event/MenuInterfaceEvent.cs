 ...
 *                                          
 *  09/09/2016  1.8     K.McD           References
 ...
 *  
 *                                      Modifications
 *                                      1.  Added the ConfigureDataStream() method. This calls the FormConfigureFaultLogParameters form to allow the user to define
 *                                          the various fault log data stream worksets.
 */
...
namespace Event
{
    ...
    public class MenuInterfaceEvent : MenuInterface
    {
        ...
        /// </summary>
        public void ConfigureDataStream()
        {
            MainWindow.Cursor = Cursors.WaitCursor;
            ...
            try
            {
                FormConfigureFaultLogParameters formConfigureFaultLogParameters = new FormConfigureFaultLogParameters(MainWindow.CommunicationInterface,
                                                                                                                      Workset.FaultLog, null);
                MainWindow.ShowDialog(formConfigureFaultLogParameters);
            }
            catch (Exception exception)
            {
