 ...
 *
 *  08/05/13    1.3     K.McD           1.  Changed the SleepMsVerisimilitudeGetRecord constant from 25 ms to 0 ms as the simulated time to load the event list was
 *                                          excessive.
 *
 *  02/03/16    1.4     DAS             References
 ...
 *                                          
 *                                      Modifications
 *                                      1.  Changed the signature of the CheckFaultLogger() method. Added a new argument to the parameter list "newEVentsLogged"
 *                                          to reflect the "real" system call.
 *
 */
