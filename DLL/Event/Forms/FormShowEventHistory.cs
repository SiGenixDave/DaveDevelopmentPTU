 ...
 *                                      
 *                                      Modifications
 *                                      1.  Modified the constructor to clear the 'Visible' property of the m_DataGridViewTextColumnCumulativeHistory
...
namespace Event.Forms
{
    ...
    public partial class FormShowEventHistory : FormConfigureEventFlags
    {
        ...
        public FormShowEventHistory(ICommunicationParent communicationInterface, Log log)
        {
            ...
            m_DataGridViewTextColumnCumulativeHistory.Visible = false;
