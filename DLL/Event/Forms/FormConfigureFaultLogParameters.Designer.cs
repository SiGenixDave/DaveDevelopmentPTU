 ...
 *                                          this is now true.
 *                                          
 *  07/12/2016  1.5     K.McD           References
 ...
 *                                      2.  Changed the Text property of the m_LegendName Label to 'Data Stream Configuration:'.
 *                                      3.  Changed the Text property of the m_GroupBoxWorkset GroupBox to 'Data Stream Configuration'.
 *                                      4.  Changed the Text property of the m_TabPageColumn1 TabPage to 'Watch Variable List'.
 *
 */
