 ...
 *                                      
 *  08/01/16    1.2     K.McD           References
 *                                      1.  PTE Changes - List 5-17-2016.xlsx Item 44. On the 'Download Event History' dialog box, remove the greyed-out 'Cancel'
 *                                          button.
 *  
 *                                      Modifications
 *                                      1.  Changed the value of the RecordsPerSec constant from 4 to 8, so that the progress bar is at the Max. position when the download completes.
 *                                      2.  Changed the value of the IntervalDisplayUpdateMs to 250 ms so that the ProgressBar proceeds more smoothly.
 */
...
namespace Event.Forms
{
    ...
    public partial class FormGetFltHistInfo : FormPTUDialog
    {
        ...
        /// </summary>
        private const int RecordsPerSec = 8;

        /// <summary>
        /// The interval, in ms, between successive display updates. Value: 125 ms.
        /// </summary>
        private const int IntervalDisplayUpdateMs = 125;
        #endregion --- Constants ---
