 ...
 *  
 *  08/10/11    1.3     Sean.D          1.  Included support for offline mode. Modified the constructor to conditionally choose CommunicationEvent or
 ...
 *                                      
 *                                      Modifications
 *                                      1.  Modified the Convert() method to include a totalCount signed integer which combines the CumulativeHistoryCount and
 *                                          RecentHistoryCount values of the EventStatus_t structure and insert this vaule into the DataGridViewRow in place of
 *                                          the RecentHistoryCount value.
 *  
 */
