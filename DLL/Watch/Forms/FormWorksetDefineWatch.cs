 ...
 * 
 *  07/11/2016  1.7     K.McD           References
 ...
 *                                          
 *                                      Modifications
 *                                      1.  Reverted previous modifications by Dave Smail back to Rev. 1.6.
 *                                      2.  Modified the UpdateCount() method to update the TabPage1 'Count' label and the overall 'Total Count' label. Individual
 *                                          TabPage 'Count' labels now use the wording '14 Item(s)' and the 'Total Count' label uses 'Count: 14 of 20'.
 */
