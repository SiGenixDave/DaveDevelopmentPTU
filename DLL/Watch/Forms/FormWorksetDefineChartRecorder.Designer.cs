 ...
 *                                          
 *                                      Modifications
 *                                      1.  Reverted previous modifications by Dave Smail back to Rev. 1.3.
 *                                      2.  Set the Visible property of the m_LabelCount1 control to false and left the Visible property of the m_LabelCountTotal
 *                                          as true.
 *                                          
 *  07/27/2016  1.5     K.McD           References
 ...
 *                                          event.
 *                                          
 *  08/01/2016  1.6     K.McD           References
 ...
 *  
 *                                      Modifications
 *                                      1.  Changed the title of the form to 'Configure - Data Stream'. - Ref.: 1, 2.
 ...
 *                                      4.  Changed the Text property of the m_GroupBoxWorkset GroupBox to 'Data Stream Layout'. - Ref.: 2.
 *                                      5.  Changed the Text property of the m_TabPageColumn1 TabPage to 'Parameters'.
 *                                      6.  Set the Visible property of the m_LabelListBoxTitle Label to false.
 *
 */
...
namespace Watch.Forms
{
    partial class FormWorksetDefineChartRecorder
    {
        ...
        private void InitializeComponent()
        {
            ...
            // m_TextBoxName
            // 
            this.m_TextBoxName.Size = new System.Drawing.Size(369, 20);
            // 
            // m_LegendSecurity
            // 
            ...
            this.m_LabelListBoxTitle.Visible = false;
            // 
