...
/*
 *  -8/02/2016  1.5     K.McD           References
 ...
 *                                      
 *                                      Modifications
 *                                      1.  Modified the Text property of the m_LegendSupplementalInformation Label to be 'Watch Configuration :'.
 */
...
namespace Watch.Forms
{
    ...
    public partial class FormOpenWatch : FormDataStreamPlot
    {
            ...
            : base(watchFile)
        {
            ...
            m_LegendSupplementalInformation.Text = Resources.LegendWatchConfiguration;
