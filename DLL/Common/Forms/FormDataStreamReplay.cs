 ...
 *                                              
 *                                      2.  SNCR - R188 PTU [20 Mar 2015] Item 17. If the user uses the ‘Remove Selected Plot(s)’ context menu option to remove one or
 *                                          more plots from the 'File/Open/Watch File', 'File/Open/Data Stream', or 'File/Open/Simulated Data Stream' screen, the
...
/*
 *  07/26/2016  1.21    K.McD       References
 ...
 *                                      
 *                                  Modifications
 *                                  1.  Added the override function to the F1_Click() event handler. This toggles the Enumeration control flag and updates the
 *                                      watch control values.
 */
