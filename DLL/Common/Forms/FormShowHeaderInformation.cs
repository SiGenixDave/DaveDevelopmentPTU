 ...
 * 
 *  10/11/11    1.6.1	Sean.D          1.  SNCR002.12 - Bug fix. Modified code in constructor to check for native NewLine and to catch consecutive \n characters.
 */
#endregion - [1.0 to 1.6.1] -

#region - [1.7] -
/*
 *  03/14/2016  1.7     K.McD           References
 ...
 *  
 *                                      Modifications
 *                                      1.  The EventLogFile_t structure now implements get and set accessors to allow the typeof(EventLogFile_t).GetProperty() method to
 *                                          be used by the CsvSerializer class. As a consequence of this, the code 'eventLogFile.Header.Comments = m_TextBoxComments.Text;'
 *                                          in the m_ButtonOK_Click() method is no longer valid and generates the error 'Cannot modify the return value of
 *                                          EventLogFile_t.Header because it is not a variable'. To correct this, the Comments property of the Header property must be
 *                                          updated indirectly.
 *  
 */
#endregion - [1.7] -
