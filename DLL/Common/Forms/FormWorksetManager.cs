 ...
 *  
 *  
 *  08/19/2016  1.6     K.McD           References
 *                                      1.  Internal Audit of Code.
 *    
 *                                      Modifications
 *                                      1.  Set all Windows Form Designer variables to null.
 *                                      2.  Detached all event handlers.
 *                                      3.  Modified the name of the instantialted FormSetSecurityLevel Form in the m_ContextMenuItemOverrideSecurity_Click() event
 *                                          handler to formSetSecurityLevel in accordance with the coding standard.
 */
