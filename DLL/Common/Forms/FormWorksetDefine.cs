...
/*
 *  07/27/2016      1.12    K.McD       References
 *                                      1.  PTE Changes - List 5-17-2016.xlsx Item 13, 27, 34. When configuring the Fault Log DataStream, Chart Recorder or Watch Window,
 *                                          the user must only be allowed to select variables from either the 'Available Watch Variables' list or the or 'Workset Layout'
 *                                          list but not both at the same time.
 *                                      
 *                                      Modifications
 *                                      1.  Added the m_ListBoxAvailable_Enter() event handler, this is called whenever the 'Available' ListBox becomes the active
 *                                          control on the form. The event handler clears any selected items associated with the ListBox controls
 *                                          for Column 1, Column 2, and Column 3.
 *                                          
 *                                      2.  Added the m_ListBoxWorkset_Enter() event handler, this is called whenever m_ListBox1, m_ListBox2, or m_ListBox3 becomes
 *                                          the active control on the form. The event handler clears any selected items associated with the 'Available' ListBox control.
 *                                          
 *                                      3.  De-Registered the event handlers associated with the ListBox control 'Enter' events.
 */

/*
 *    08/01/2016    1.13    K.McD       References
 ...
 *    
 *                                      Modifications
 *                                      1.  Changed the modifiers to protected for the m_ListBoxAvailable_Enter() and m_ListBoxWorkset_Enter() event handlers.
 *                                      2.  Made the m_ListBoxWorkset_Enter() event handler virtual.
 *                                      3.  Modified the m_TabControlColumns_SelectedIndexChanged() event handler to clear the selected ListBox control.
 *                                      
 */

/*
 *    08/19/2016    1.14    K.McD       References
 *                                      1.  Internal Audit of Code.
 *                                      
 ...
 *    
 *                                      Modifications
 *                                      1.  Set all Windows Form Designer variables to null.
 *                                      2.  Modified the Set Accessor of the ModifyEnabled property to include the 'Enabled' property of the: 'ListBox' and 'TextBox'
 *                                          controls.
 */
    ...
    public partial class FormWorksetDefine : FormPTUDialog, IDataUpdate
    {
        ...
        protected override void Cleanup(bool disposing)
        {
            try
            {
                ...
                this.m_ListBox1.Enter -= new System.EventHandler(this.m_ListBoxWorkset_Enter);
                this.m_ListBox2.Enter -= new System.EventHandler(this.m_ListBoxWorkset_Enter);
                this.m_ListBox3.Enter -= new System.EventHandler(this.m_ListBoxWorkset_Enter);
                this.m_ListBoxAvailable.Enter -= new System.EventHandler(this.m_ListBoxAvailable_Enter);
                ...
                m_LegendName2 = null;
                m_TextBoxName = null;
                m_LegendSecurity = null;
                m_TextBoxSecurityLevel = null;
                m_GroupBoxWorkset = null;
                m_TabControlColumn = null;
                m_TabPageColumn1 = null;
                m_TabPageColumn2 = null;
                m_TabPageColumn3 = null;
                m_ListBox1 = null;
                m_ListBox2 = null;
                m_ListBox3 = null;
                m_LabelCount1 = null;
                m_LabelCount2 = null;
                m_LabelCount3 = null;
                m_LabelCountTotal = null;
                m_LegendHeader1 = null;
                m_TextBoxHeader1 = null;
                m_LegendHeader2 = null;
                m_TextBoxHeader2 = null;
                m_LegendHeader3 = null;
                m_TextBoxHeader3 = null;
                m_GroupBoxAvailable = null;
                m_TabControlAvailable = null;
                m_TabPageAll = null;
                m_ListBoxAvailable = null;
                m_LabelAvailableCount = null;
                m_ButtonRemove = null;
                m_ButtonMoveUp = null;
                m_ButtonMoveDown = null;
                m_ButtonOK = null;
                m_ButtonCancel = null;
                m_ButtonApply = null;
                m_ButtonAdd = null;
                m_ContextMenuColumns = null;
                m_ContextMenuAll = null;
                m_MenuItemChangeChartScaleFactor = null;
                m_MenuItemConfigureBitmaskPlot = null;
                m_ListBox1RowHeader = null;
                m_ListBox3RowHeader = null;
                m_ListBox2RowHeader = null;
                m_LabelListBox1ColumnHeader = null;
                m_LabelListBox2ColumnHeader = null;
                m_LabelListBox3ColumnHeader = null;
                m_LabelListBoxAvailableColumnHeader = null;
                m_PanelStatusMessage = null;
                m_ButtonClear = null;
                m_LegendSearch = null;
                m_TextBoxSearch = null;
                m_MenuItemShowDefinition = null;
                m_MenuItemShowDefinitionAll = null;
                m_ErrorProvider = null;
                m_LabelStatusMessage = null;
                m_LegendImageStatusMessage = null;
       ...
       /// <param name="sender">Reference to the object that raised the event.</param>
        ...
        /// <param name="sender">Reference to the object that raised the event.</param>
        /// <param name="e">Parameter passed from the object that raised the event.</param>
        protected void m_ListBoxAvailable_Enter(object sender, EventArgs e)
        {
            m_ListBox1.ClearSelected();
            m_ListBox2.ClearSelected();
            m_ListBox3.ClearSelected();
        }
        ...
        /// <param name="sender">Reference to the object that raised the event.</param>
        /// <param name="e">Parameter passed from the object that raised the event.</param>
        protected virtual void m_ListBoxWorkset_Enter(object sender, EventArgs e)
        {
            m_ListBoxAvailable.ClearSelected();
        }
        #endregion - [ListBox] -
        ...
        private void m_TabControlColumns_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // Start afresh, ensure that any previously selected items are cleared from this ListBox.
            m_ListBoxSelected.ClearSelected();
        }
        ...
        protected bool ModifyEnabled
        {
            ...
            { 
                ...
                m_ListBox1.Enabled = m_ModifyEnabled;
                m_ListBox2.Enabled = m_ModifyEnabled;
                m_ListBox3.Enabled = m_ModifyEnabled;
                m_ListBoxAvailable.Enabled = m_ModifyEnabled;
                m_TextBoxHeader1.Enabled = m_ModifyEnabled;
                m_TextBoxHeader2.Enabled = m_ModifyEnabled;
                m_TextBoxHeader3.Enabled = m_ModifyEnabled;
                m_TextBoxSearch.Enabled = m_ModifyEnabled;
            }
        }
