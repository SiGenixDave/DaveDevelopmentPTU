        ...
        private void AddEventVariableLists()
        {
            ...
            for (short eventIdentifier = 0; eventIdentifier < m_IdentifierMax + 1; eventIdentifier++)
            {
                ...
                try
                {
                    ...
                    {
                        // The STRUCT table of the data dictionary does not include any event variables associated with the structure identifier
                    ...
                    {
                        // The STRUCT table of the data dictionary does not include any event variables associated with the structure identifier
                        // defined in the current event and the specified structure identifier is higher than the maximum structure identifier included in
                        // the STRUCT table. This covers the case where an additional event is added to the data table that has no additional event variables.
                        continue;
                    }
                }
                catch (NullReferenceException)
