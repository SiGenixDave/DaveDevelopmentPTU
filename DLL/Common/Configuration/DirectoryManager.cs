...
/*
 *  Date        Version     Author  Comments
 *  05/12/2016  1.5         K.McD   References
 ...
 * 
 *                                  Modifications
 *                                  1.  Changed the main directory associated with the '\Configuration Files', '\Workset Files' and '\Diagnostic Help Files'
 *                                      sub-directories from 'Environment.SpecialFolder.ApplicationData' to 'Environment.SpecialFolder.CommonDocuments' i.e.
 *                                      to 'C:\Users\Public\Documents' for Windows 7 based systems and '' for XP based systems so that all users can access these
 *                                      directories.
 */
#endregion - [1.5] -
    ...
    public static class DirectoryManager
    {
        ...
        public static string PathPTUConfigurationFiles
        {
            get
            {
                ...
                return Environment.GetFolderPath(Environment.SpecialFolder.CommonDocuments) + Resources.PathRelativeApplicationData +
