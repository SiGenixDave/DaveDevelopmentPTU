 ...
 *  
 *  04/07/2016  1.4     K.McD           References
 ...
 *                                          
 *                                      Modifications
 *                                      1.  Added the SelfTestErrorMessageList property and associated member variable.
 *                                      2.  Modified the Initialize() method to populate the SelfTestErrorMessageList property with the contents of the SELFTESTERRMESS
...
namespace Common.Configuration
{
    ...
    public static class Lookup
    {
        ...
        /// </summary>
        private static List<SelfTestErrorMessage_t> m_SelfTestErrorMessageList = new List<SelfTestErrorMessage_t>();
        ...
        public static void Initialize(DataDictionary dataDictionary)
        {
            ...
            //Create the Self Test Error Message list.
            for (UInt16 index = 0; index < dataDictionary.SELFTESTERRMESS.Count; index++)
            {
                SelfTestErrorMessage_t selfTestErrorMessage = new SelfTestErrorMessage_t();
                selfTestErrorMessage.ErrorIdentifier = (short)dataDictionary.SELFTESTERRMESS[index].ERRID;
                selfTestErrorMessage.Description = dataDictionary.SELFTESTERRMESS[index].DESCRIPTION;
                m_SelfTestErrorMessageList.Add(selfTestErrorMessage);
            }
        }
        #endregion --- Methods ---
        ...
        /// </summary>
        public static List<SelfTestErrorMessage_t> SelfTestErrorMessageList
        {
            get { return m_SelfTestErrorMessageList; }
        }
