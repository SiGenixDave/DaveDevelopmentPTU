...
#region - [1.13] -
/*
 *  03/15/16    1.13    K.McD           References
 ...
 *                                              store them in human readable format in additional columns within the CSV file. Event counters shall be stored in a
 ...
 *                                              
 *                                      Modifications
 *                                      1.  Modified the EventLogFile_t structure to use get and set accessors to access the private member variables.
 *                                      2.  Added Csv to the FormatType enumerator.
 *                                      3.  Modified the Serialize<T>() method to check whether the format type is FormatType.Csv and, if so, to instantiate the
 *                                          CsvSerializer class and call the Serialize() method.
 */
#endregion - [1.13] -
...
namespace Common
{
    ...
    public struct EventLogFile_t
    {
        ...
        public EventLogFile_t(Header_t header, List<EventRecord> eventRecordList)
        {
            ...
            m_EventRecordList = new List<EventRecord>();
            m_EventRecordList.AddRange(eventRecords);
            m_Filename = string.Empty;
            m_FullFilename = string.Empty;
        }
        #endregion - [Constructors] -
        ...
        {
            get { return m_EventRecordList; }
            set { m_EventRecordList = value; }
        }
