 ...
 * 
 *                                  2.  Added the event handlers for: (a) the name field 'DoubleClick' event, (b) the 'Show Flags' context menu option 'Click' event
 *                                      and (c) the 'Show Definition' context menu option 'Click' event.
 * 
 ...
 *                                  2.  Removed the m_LabelNameField_DoubleClick() event handler. This event is re-directed in the EventControl.Designer.cs file. 
 *
