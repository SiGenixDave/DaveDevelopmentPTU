...
namespace Common.UserControls
{
    ...
    /// </summary>
    public partial class EventEnumeratorControl : EventControl
    {
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (m_LabelNameField.Text != CommonConstants.VariableNotDefinedString)
                    {
                        ...
                        {
                            if (m_ClientAsFormPTU.ShowEnumeratorAsInteger == true)
                            {
                        ...
                        try
                        {
                            ...
                            m_LabelValueField.Text = Lookup.EventVariableTable.GetEnumeratorText(m_Identifier, m_ValueUINT);
                        }
                        catch (Exception)
                        {
                            m_Value = double.NaN;
