 ...
 *                                      
 *  07/25/2016  1.4     K.McD           References
 *                                      1.  PTE Changes - List 5-17-2016.xlsx Item 63. Change the '(Bit Mask)' component of the Bitmask UserControl to say 'Detail'
 *                                          and make it look like a clickable button.
 *                                          
 *                                      2.  Bug Fix - SNCR-PTU [01 Mar 2016] - Item 22. On the event screen, modify the width of the event variable user control to allow
 *                                          for a vertical scroll bar.
 *                                      
 *                                      Modifications
 *                                      1.  Set the WidthUnitsField property to be virtual. - Ref.: 1.
 *                                      2.  Added the WidthVerticalScrollBar constant. - Ref.: 2.
 *                                      3.  Set the DefaultWidthValueField and DefaultWidthUnitsField modifiers to protected. - Ref.: 2. 
 * 
 */
...
namespace Common.UserControls
{
    ...
    public partial class VariableControl : UserControl
    {
        ...
        /// </summary>
        protected const int DefaultWidthValueField = 100;

        /// <summary>
        /// The default width of the units field. Value: 100.
        /// </summary>
        protected const int DefaultWidthUnitsField = 100;

        /// <summary>
        /// The width, in pixels, of the vertical scroll bar. Value: 28.
        /// </summary>
        protected const int WidthVerticalScrollBar = 28;
        #endregion --- Constants ---
        ...
        public virtual int WidthUnitsField
        {
