 ...
 *                                      event.
 *                                      
 *  07/22/2016  1.2     K.McD       References
 ...
 *                                          
 *                                  Modifications
 *                                  1.  Added the 'Details' Button control and attached the 'Click' event to the m_MenuItemShowFlags_Click() event handler. - Ref.: 1.
 *                                  2.  Set the ForeColor property of the m_LabelValueField Label to be Black. - Ref.: 2.
 *                                  3.  Set the TextAlign property of the m_LabelUnitsField Label to be TopLeft. - Ref.: 1.
 */
...
namespace Common.UserControls
{
    partial class EventBitmaskControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // m_LabelValueField
            // 
            this.m_LabelValueField.ForeColor = System.Drawing.Color.Black;
            // 
            // m_LabelUnitsField
            // 
            this.m_LabelUnitsField.TextAlign = System.Drawing.ContentAlignment.TopLeft;
