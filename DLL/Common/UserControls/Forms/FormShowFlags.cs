 ...
 *  
 *  07/20/2016  1.9     K.McD           References
 *                                      1.  PTE Changes - List 5-17-2016.xlsx Item 62. On all screens, change the green text to black. 
 *                                      
 *                                      Modifications
 *                                      1.  Initialized the m_ForeColorClearState readonly member variable to Color.Black.
 */
...
namespace Common.UserControls
{
    ...
    public partial class FormShowFlags : FormPTUDialog
    {
        ...
        /// </summary>
        private readonly Color m_ForeColorClearState = Color.Black;
